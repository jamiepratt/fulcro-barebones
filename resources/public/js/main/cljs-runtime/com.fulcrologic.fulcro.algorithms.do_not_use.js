...
var vec__50675 = ((cljs.core.seq_QMARK_(expr))?cljs.core.ffirst(expr):cljs.core.first(expr));
...
var expr__$1 = (function (){var G__50690 = expr;
if(cljs.core.seq_QMARK_(expr)){
return cljs.core.first(G__50690);
} else {
return G__50690;
}
})();
...
if(cljs.core.seq_QMARK_(expr)){
var G__50691 = cljs.core.first(expr);
return (com.fulcrologic.fulcro.algorithms.do_not_use.join_key.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.algorithms.do_not_use.join_key.cljs$core$IFn$_invoke$arity$1(G__50691) : com.fulcrologic.fulcro.algorithms.do_not_use.join_key.call(null, G__50691));
} else {
return expr;
...
/** @this {Function} */
(com.fulcrologic.fulcro.algorithms.do_not_use.deep_merge.cljs$lang$applyTo = (function (seq50697){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq50697));
}));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [["The composed root query is not valid EQL. The app may crash. See `(comp/get-query ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__50743 = query;
var G__50743__$1 = (((G__50743 == null))?null:cljs.core.meta(G__50743));
var G__50743__$2 = (((G__50743__$1 == null))?null:new cljs.core.Keyword(null,"component","component",1555936782).cljs$core$IFn$_invoke$arity$1(G__50743__$1));
if((G__50743__$2 == null)){
return null;
} else {
return (component_name_fn.cljs$core$IFn$_invoke$arity$1 ? component_name_fn.cljs$core$IFn$_invoke$arity$1(G__50743__$2) : component_name_fn.call(null, G__50743__$2));
}
})()),")`"].join(''),query], null);
}),null)),null,-1060962215,null);
} else {
}

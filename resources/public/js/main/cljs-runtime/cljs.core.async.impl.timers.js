...
var i_36981 = (self__.level + (1));
while(true){
if((i_36981 <= (new_level + (1)))){
(update[i_36981] = self__.header);

var G__36982 = (i_36981 + (1));
i_36981 = G__36982;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_36983 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_36983[i]));
} else {
x__$2.forward.push((((i < links_36983.length))?(links_36983[i]):null));
}

if((i < links_36983.length)){
(links_36983[i] = x__$2);
} else {
links_36983.push(x__$2);
}
...
var i_36985 = (0);
while(true){
if((i_36985 <= self__.level)){
var links_36986 = (update[i_36985]).forward;
if((x__$1 === (((i_36985 < links_36986.length))?(links_36986[i_36985]):null))){
(links_36986[i_36985] = (x__$1.forward[i_36985]));

var G__36987 = (i_36985 + (1));
i_36985 = G__36987;
continue;
} else {
var G__36988 = (i_36985 + (1));
i_36985 = G__36988;
continue;
}
} else {
...
var G__36990 = nx;
var G__36991 = (level__$1 - (1));
x = G__36990;
level__$1 = G__36991;
continue;
} else {
var G__36992 = x;
var G__36993 = (level__$1 - (1));
x = G__36992;
level__$1 = G__36993;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__36995 = nx;
var G__36996 = (level__$1 - (1));
x = G__36995;
level__$1 = G__36996;
continue;
} else {
var G__36997 = x;
var G__36998 = (level__$1 - (1));
x = G__36997;
level__$1 = G__36998;
continue;
}

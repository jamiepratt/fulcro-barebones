...
var ensure_set_42902 = taoensso.truss.impl.ensure_set;
taoensso.truss.impl.ks_EQ_ = (function taoensso$truss$impl$ks_EQ_(ks,m){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.set(cljs.core.keys(m)),(ensure_set_42902.cljs$core$IFn$_invoke$arity$1 ? ensure_set_42902.cljs$core$IFn$_invoke$arity$1(ks) : ensure_set_42902.call(null, ks)));
});

taoensso.truss.impl.ks_LT__EQ_ = (function taoensso$truss$impl$ks_LT__EQ_(ks,m){
return clojure.set.subset_QMARK_(cljs.core.set(cljs.core.keys(m)),(ensure_set_42902.cljs$core$IFn$_invoke$arity$1 ? ensure_set_42902.cljs$core$IFn$_invoke$arity$1(ks) : ensure_set_42902.call(null, ks)));
});

taoensso.truss.impl.ks_GT__EQ_ = (function taoensso$truss$impl$ks_GT__EQ_(ks,m){
return clojure.set.superset_QMARK_(cljs.core.set(cljs.core.keys(m)),(ensure_set_42902.cljs$core$IFn$_invoke$arity$1 ? ensure_set_42902.cljs$core$IFn$_invoke$arity$1(ks) : ensure_set_42902.call(null, ks)));
});

taoensso.truss.impl.ks_nnil_QMARK_ = (function taoensso$truss$impl$ks_nnil_QMARK_(ks,m){
return taoensso.truss.impl.revery_QMARK_((function (p1__42810_SHARP_){
return taoensso.truss.impl.some_QMARK_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(m,p1__42810_SHARP_));
}),ks);
});
...
var vec__42818 = pred;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42818,(0),null);
var a1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42818,(1),null);
var a2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42818,(2),null);
var a3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42818,(3),null);
...
var vec__42841 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [self(a1),self(a2),self(a3)], null);
var vec__42844 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42841,(0),null);
var a1__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42844,(0),null);
var sf_a1_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42844,(1),null);
var vec__42847 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42841,(1),null);
var a2__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42847,(0),null);
var sf_a2_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42847,(1),null);
var vec__42850 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42841,(2),null);
var a3__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42850,(0),null);
var sf_a3_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42850,(1),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42853__$1)].join('')));
...
var G__42878 = (new cljs.core.Delay((function (){
...
return (error_fn.cljs$core$IFn$_invoke$arity$1 ? error_fn.cljs$core$IFn$_invoke$arity$1(G__42878) : error_fn.call(null, G__42878));
} else {
return null;
}
});

...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_35276 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_35276(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_35277 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_35277(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_35278 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_35278(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_35279 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_35279(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_35280 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_35280(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_35284 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_35284(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_35286 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_35286(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_35292 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_35292(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_35293 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_35293(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_35294 = (function (b,itm){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_35294(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_35295 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_35295(b);
}
});

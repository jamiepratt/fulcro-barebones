...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_41874 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_41874(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_41875 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_41875(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41877 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41877(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41880 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41880(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41881 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41881(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41882 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41882(reader);
}
});
...
var G__41910 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__41911 = s.append(c);
c = G__41910;
s = G__41911;
continue;
}

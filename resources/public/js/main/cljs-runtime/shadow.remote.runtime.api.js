...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_36826 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_36826(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_36827 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_36827(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_36831 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_36831(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_36832 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_36832(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_36835 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_36835(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_36836 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_36836(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__36824,callback){
var map__36825 = p__36824;
var map__36825__$1 = cljs.core.__destructure_map(map__36825);
var input = map__36825__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36825__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36825__$1,new cljs.core.Keyword(null,"ns","ns",441598760));

...
var i__5770__auto___32832 = (0);
while(true){
if((i__5770__auto___32832 < len__5769__auto___32830)){
args__5775__auto__.push((arguments[i__5770__auto___32832]));

var G__32835 = (i__5770__auto___32832 + (1));
i__5770__auto___32832 = G__32835;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq32732){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32733,G__32734,seq32732__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__32751_SHARP_){
return (!((cljs.core.meta(p1__32751_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32787__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e32788){var _e__31060__auto__ = e32788;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e32794){var _e__31060__auto__ = e32794;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__32797 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__32798 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__32798);

try{var map__32800 = opts;
var map__32800__$1 = cljs.core.__destructure_map(map__32800);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32800__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__32797);
}});
...
var temp__5802__auto___32850 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___32850)){
var managed_print_level_32851 = temp__5802__auto___32850;
var _STAR_print_level_STAR__orig_val__32805_32852 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__32806_32853 = managed_print_level_32851;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__32806_32853);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__32804_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__32804_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__32805_32852);
}} else {
job_fn();
}

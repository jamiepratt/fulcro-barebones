 ...
 *   lookup refs.
 */
com.fulcrologic.fulcro.algorithms.denormalize.follow_ref = (function com$fulcrologic$fulcro$algorithms$denormalize$follow_ref(state_map,p__50686){
var vec__50687 = p__50686;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50687,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50687,(1),null);
var ref = vec__50687;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.ref_key = (function com$fulcrologic$fulcro$algorithms$denormalize$ref_key(p__50692){
var vec__50693 = p__50692;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50693,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50693,(1),null);
var ref = vec__50693;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),id)){
return table;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (n,p__50708){
var map__50709 = p__50708;
var map__50709__$1 = cljs.core.__destructure_map(map__50709);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50709__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_join_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_join_BANG_(n,p__50728,entity,state_map,parent_node,idents_seen){
var map__50730 = p__50728;
var map__50730__$1 = cljs.core.__destructure_map(map__50730);
var join_node = map__50730__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50730__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50730__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_union_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_union_BANG_(n,p__50756,entity,state_map,idents_seen){
var map__50757 = p__50756;
var map__50757__$1 = cljs.core.__destructure_map(map__50757);
var join_node = map__50757__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50757__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var link_join_QMARK_ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(key);
...
var union_key__GT_query = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__50758){
var map__50759 = p__50758;
var map__50759__$1 = cljs.core.__destructure_map(map__50759);
var node = map__50759__$1;
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50759__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
...
var vec__50760 = lookup_ref;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50760,(0),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var e = temp__5802__auto__;
var temp__5802__auto____$1 = (function (){var G__50763 = cljs.core.first(v);
return (union_key__GT_query.cljs$core$IFn$_invoke$arity$1 ? union_key__GT_query.cljs$core$IFn$_invoke$arity$1(G__50763) : union_key__GT_query.call(null, G__50763));
})();
if(cljs.core.truth_(temp__5802__auto____$1)){
var target_ast_node = temp__5802__auto____$1;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.denormalize = (function com$fulcrologic$fulcro$algorithms$denormalize$denormalize(p__50765,current_entity,state_map,idents_seen){
var map__50766 = p__50765;
var map__50766__$1 = cljs.core.__destructure_map(map__50766);
var top_node = map__50766__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50766__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50766__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"*","*",345799209,null),(function (){var G__50767 = nil_nodes;
var G__50767__$1 = (((G__50767 == null))?null:cljs.core.first(G__50767));
if((G__50767__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(G__50767__$1);
}
})());
} else {
return and__5043__auto__;
...
var G__50768 = result_node__$1;
var G__50768__$1 = (((G__50768 == null))?null:cljs.core.persistent_BANG_(G__50768));
if((G__50768__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__50768__$1,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var _STAR_denormalize_time_STAR__orig_val__50770 = com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_;
var _STAR_denormalize_time_STAR__temp_val__50771 = com.fulcrologic.fulcro.algorithms.denormalize.current_time();
(com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_ = _STAR_denormalize_time_STAR__temp_val__50771);

try{var ast = edn_query_language.core.query__GT_ast(query);
var G__50772 = com.fulcrologic.fulcro.algorithms.denormalize.denormalize(ast,starting_entity,state_map,cljs.core.PersistentArrayMap.EMPTY);
if((G__50772 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__50772,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
}finally {(com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_ = _STAR_denormalize_time_STAR__orig_val__50770);
}});
/**
...
var G__50773 = props;
var G__50773__$1 = (((G__50773 == null))?null:cljs.core.meta(G__50773));
if((G__50773__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","time","com.fulcrologic.fulcro.algorithms.denormalize/time",-375164969).cljs$core$IFn$_invoke$arity$1(G__50773__$1);
}
});
/**
...
var _STAR_root_keys_and_idents_STAR__orig_val__50774 = com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_;
var _STAR_root_keys_and_idents_STAR__temp_val__50775 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.transient$(cljs.core.PersistentHashSet.createAsIfByAssoc([root_key_or_ident])));
(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__temp_val__50775);
...
}finally {(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__orig_val__50774);
}});
/**
...
var map__50776 = cljs.core.meta(prior_props);
var map__50776__$1 = cljs.core.__destructure_map(map__50776);
var visited = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50776__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","visited","com.fulcrologic.fulcro.algorithms.denormalize/visited",823384252));
var source_state_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50776__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","source-state-map","com.fulcrologic.fulcro.algorithms.denormalize/source-state-map",-1097808870));

...
var G__32720 = devtools.prefs.pref(v);
v = G__32720;
continue;
} else {
return v;
...
}catch (e32665){var _e__31060__auto__ = e32665;
return false;
}})();
...
}catch (e32670){var _e__31060__auto__ = e32670;
return false;
}})();
...
}catch (e32673){var _e__31060__auto__ = e32673;
return false;
}}
}
});
...
var vec__32679 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32679,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32679,(1),null);
...
return cljs.core.some((function (p1__32685_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__32685_SHARP_);
}),template);
});
